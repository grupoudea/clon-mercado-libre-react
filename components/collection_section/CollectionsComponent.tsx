...
const CollectionsComponent = () => {
    ...
    return (
            <div className="mt-20">
                ...
                <div className="justify-center mx-auto max-w-[1200px] flex mt-1 flex-row sm:gap-4 gap-8">
                    <div className="bg-white shadow-md rounded-4 mr-4">
                        <div>
                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-4 mt-8 sm:mt-0">
