...
const DiscoverComponent = () => {
  ...
  return (
    <>
      <div className='h-full max-h-[750px] px-2 pt-9'>
        ...
        <div className='flex flex-row justify-center gap-[15px] max-md:flex-wrap'>
          {items.map((item, idKey) => (
            <DiscoverItemComponent
              key={idKey}
              mainText1={item.mainText1}
              mainText2={item.mainText2}
