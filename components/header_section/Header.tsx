    ...
    return (
        <div className="flex bg-yellow-ml min-h-[100px] justify-center w-full basis-full ">
            <div className="flex flex-wrap  gap-y-3 pt-2 pr-2.5 pb-3 pl-2.5 bg-yellow-ml">
                <div className="flex lg:basis-1/6 md:basis-full md:justify-center sm:basis-full basis-full justify-center h-[34px]">
                ...
                <div className="flex lg:basis-2/6 "></div>
                <div className="flex lg:basis-1/6 md:basis-1/3 sm:basis-full basis-full  cursor-pointer text-xs justify-center 
                    h-[34px] items-center ">
                    <a>Ingresa tu domicilio</a>
                </div>
                <div className="flex lg:basis-3/6 md:basis-[47%] sm:basis-full basis-full">
                ...
                <div className="flex lg:basis-2/6 lg:justify-end md:basis-full basis-full  justify-center gap-x-[60px]">
                    <ul className="flex w-full gap-x-3  list-none
                items-center text-xs text-gray-menu ">
